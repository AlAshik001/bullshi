...
export const MacbookProDesktop = ()=> {
    // The rest of your original desktop-first code here...
...
<<<<<<< HEAD:src/screens/MacbookPro/MacbookPro.tsx
          />
        ))}
      </div>
...
=======
>>>>>>> 3c4557c (2):src/screens/MacbookPro/MacbookProDesktop.jsx
          />
        ))}
      </div>

      {/* --- REFACTORED HEADER --- */}
      <header className="absolute top-14 left-1/2 transform -translate-x-1/2 w-[90%] max-w-6xl h-[120px] bg-[#bccbff]/45 rounded-[75px] flex items-center justify-between px-10">
        {/* Left Side: Logo and Title */}
        <div className="flex items-center gap-5">
            <div className="w-[94px] h-[94px] rounded-[47px] bg-[linear-gradient(106deg,rgba(82,40,207,1)_16%,rgba(255,255,255,0.25)_50%,rgba(82,40,207,1)_90%)] flex items-center justify-center shrink-0">
                <img
                    className="w-[80%] h-[58%] object-contain"
                    alt="Logo"
                    src="/mask-group-9.png"
                />
            </div>
            <h1 className="[font-family:'Inter',Helvetica] font-medium text-black text-[40px] hidden lg:block">
                Helping MBBS
            </h1>
        </div>
...
=======
        ...
        <nav className="hidden md:flex items-center gap-16">
            <Link to="/" className="[font-family:'Inter',Helvetica] font-normal text-2xl tracking-[0] leading-[normal] text-black hover:text-[#0e70c9] transition-colors">
                Home
            </Link>
            <Link to="#" className="[font-family:'Inter',Helvetica] font-normal text-2xl tracking-[0] leading-[normal] text-[#0e70c9] font-semibold">
                About Us
            </Link>
            <Link to="/services" className="[font-family:'Inter',Helvetica] font-normal text-2xl tracking-[0] leading-[normal] text-black hover:text-[#0e70c9] transition-colors">
                Join Us
            </Link>
        </nav>

        {/* Right Side: Profile Icon */}
        <div className="w-[79px] h-[78px] rounded-[39.5px/39px] bg-[linear-gradient(106deg,rgba(82,40,207,1)_16%,rgba(255,255,255,0.25)_50%,rgba(82,40,207,1)_90%)] shrink-0" />
>>>>>>> 3c4557c (2):src/screens/MacbookPro/MacbookProDesktop.jsx
      </header>
